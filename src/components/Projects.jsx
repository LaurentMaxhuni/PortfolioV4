      ...
      <div className="container">
        ...
        <div className="projects-row tw-grid tw-grid-cols-1 md:tw-grid-cols-2 lg:tw-grid-cols-3 tw-place-items-center tw-gap-10 my-4">
          <ProjectCard
            ...
            repoLink="https://github.com/LaurentMaxhuni/Vuent.ai.git"
            delay="100"
          />
          <ProjectCard
            image={weatherio}
            ...
            repoLink="https://github.com/LaurentMaxhuni/weatherio.git"
            delay="200"
          />
          <ProjectCard
            image={threees}
            ...
            repoLink="https://github.com/LaurentMaxhuni/digital-art.git"
            delay="300"
          />
          <ProjectCard
            image={brainwave}
            ...
            repoLink="https://github.com/LaurentMaxhuni/Brainwave.git"
            delay="100"
          />
          <ProjectCard
            image={quickit}
          ...
          <ProjectCard
            ...
            repoLink="https://github.com/LaurentMaxhuni/xinder.git"
            delay="300"
          />
        </div>
      </div>
